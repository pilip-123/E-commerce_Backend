            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-white py-3 rounded-4 d-flex align-items-center justify-content-between">
                    <h5 class="fw-bold mb-0 fs-6">
                        <i class="bi bi-box text-success me-2"></i>Product Information
                    </h5>
                    <span class="text-muted small">Created {{ $product->created_at?->format('M d, Y') }}</span>
                </div>
                <div class="card-body p-4">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0 bg-light rounded-3 p-3">{{ $product->category->name ?? 'Uncategorized' }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-muted mb-1">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0 bg-light rounded-3 p-3">{{ $product->stock }} units</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-muted mb-1">
                        ...
                        @if ($product->relationLoaded('activePromotions') && $product->activePromotions->isNotEmpty())
                            <div class="col-12">
                                <label class="form-label fw-semibold small text-muted mb-1">
                                    <i class="bi bi-percent me-1"></i>Active Promotions
                                </label>
                        ...
                        <div class="col-12">
                            ...
                            <p class="mb-0 bg-light rounded-3 p-3">{{ $product->description ?? 'No description provided.' }}</p>
                        </div>
                    </div>
            ...
            @if ($product->reviews && $product->reviews->count() > 0)
                <div class="card border-0 shadow-sm rounded-4 mt-4">
                    <div class="card-header bg-white py-3 rounded-4">
                        <h5 class="fw-bold mb-0 fs-6">
                            <i class="bi bi-star text-warning me-2"></i>Reviews ({{ $product->reviews->count() }})
                        </h5>
                    </div>
                    <div class="card-body p-4">
