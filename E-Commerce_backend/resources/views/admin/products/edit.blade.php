    ...
    <div class="container-fluid p-0">
        <div class="card border-0 shadow-sm rounded-4" style="max-width: 720px;">
            <div class="card-header bg-white py-3 rounded-4">
                <h5 class="fw-bold mb-0 fs-6"><i class="bi bi-pencil-square me-2 text-success"></i>{{ __('Edit Product') }}
                </h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="productDescription" rows="6"
                                ...
                                style="min-height: 150px;">{{ old('description', strip_tags($product->description)) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="d-flex gap-3 pt-1">
                                <div class="form-check">
                                    <input type="radio" name="status" value="1" class="form-check-input"
                                        id="statActive" {{ old('status', $product->status) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="radio" name="status" value="0" class="form-check-input"
                                        id="statInactive" {{ !old('status', $product->status) ? 'checked' : '' }}>
