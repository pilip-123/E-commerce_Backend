...
<div class="container-fluid p-0">
    <div class="card border-0 shadow-sm rounded-4" style="max-width: 720px;">
        <div class="card-header bg-white py-3 rounded-4">
            <h5 class="fw-bold mb-0 fs-6"><i class="bi bi-pencil-square me-2 text-success"></i>Edit Promotion</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="discount_type" class="form-select form-select-sm @error('discount_type') is-invalid @enderror" required>
                            ...
                            <option value="fixed" {{ old('discount_type', $promotion->discount_type) === 'fixed' ? 'selected' : '' }}>Fixed ($)</option>
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="3"
                                  ...
                                  placeholder="Promotion description">{{ old('description', $promotion->description) }}</textarea>
