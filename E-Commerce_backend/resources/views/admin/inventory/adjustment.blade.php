...
<div class="container-fluid p-0">
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-white py-3 rounded-4 d-flex flex-wrap align-items-center gap-2">
            <div>
                <h5 class="fw-bold mb-0">Inventory Adjustment</h5>
                <small class="text-muted">Correct stock quantities</small>
            </div>
            ...
            <form method="POST" action="{{ route('admin.inventory.adjustment.store') }}">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="reason" class="form-control @error('reason') is-invalid @enderror" rows="3" placeholder="Explain why this adjustment is needed" required>{{ old('reason') }}</textarea>
