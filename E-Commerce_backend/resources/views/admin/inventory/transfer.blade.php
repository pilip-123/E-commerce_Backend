...
@section('title', __('Transfer Inventory'))
...
<div class="container-fluid p-0">
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-white py-3 rounded-4 d-flex flex-wrap align-items-center gap-2">
            <div>
                <h5 class="fw-bold mb-0">{{ __('Transfer Inventory') }}</h5>
                <small class="text-muted">{{ __('Move stock between products') }}</small>
            </div>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.inventory.transfer.store') }}">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">{{ __('From Product') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">{{ __('To Product') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-info px-4 text-white">
                            <i class="bi bi-arrow-left-right me-1"></i>{{ __('Transfer Stock') }}
                        </button>
                    </div>
                </div>
            </form>
