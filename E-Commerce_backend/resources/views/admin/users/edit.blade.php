...
<div class="container-fluid p-0">
    <div class="card border-0 shadow-sm rounded-4" style="max-width: 720px;">
        <div class="card-header bg-white py-3 rounded-4">
            <h5 class="fw-bold mb-0 fs-6"><i class="bi bi-person-gear me-2 text-success"></i>Edit User</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <div class="drop-zone {{ $user->image_url ? 'has-image' : '' }}" id="avatarZone" style="padding: 1rem;">
                            ...
                            <div id="dropContent" class="{{ $user->image_url ? 'd-none' : '' }}">
                                ...
                                <p class="mb-0 mt-1 small fw-semibold">Drop image or click</p>
                            </div>
                            <div id="dropPreview" class="{{ $user->image_url ? '' : 'd-none' }}">
                                ...
                                <p class="mb-0 mt-1 small text-muted" id="fileName">{{ $user->image_url ? 'Click to change' : '' }}</p>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $user->phone) }}"
                               class="form-control form-control-sm @error('phone') is-invalid @enderror" placeholder="Optional">
