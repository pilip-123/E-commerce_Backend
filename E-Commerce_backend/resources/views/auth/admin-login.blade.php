        ...
        <div class="w-full max-w-[1200px] bg-white rounded-[20px] shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 animate-slideUp">
            ...
            <div class="p-8 lg:p-12 xl:p-16 flex flex-col justify-center">
                    ...
                    <div>
                        <div class="relative group">
                            <select name="role" required
                                class="w-full h-[55px] px-4 border border-gray-200 rounded-[14px] text-[#1E293B] outline-none transition-all duration-300 focus:border-[#38BDF8] focus:ring-4 focus:ring-[#38BDF8]/10 bg-white text-[15px]">
                ...
                <p class="mt-6 text-center text-sm text-[#64748B]">
                    <a href="{{ route('login') }}" class="font-semibold text-[#38BDF8] hover:text-[#0EA5E9] transition-colors duration-300">Back to User Login</a>
                </p>
