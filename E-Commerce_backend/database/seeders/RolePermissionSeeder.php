...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'purchases.view', 'display_name' => 'View Purchase Orders', 'group' => 'Purchase Orders'],
            ['name' => 'purchases.create', 'display_name' => 'Create Purchase Orders', 'group' => 'Purchase Orders'],
            ['name' => 'purchases.update', 'display_name' => 'Edit Purchase Orders', 'group' => 'Purchase Orders'],
            ['name' => 'purchases.approve', 'display_name' => 'Approve Purchase Orders', 'group' => 'Purchase Orders'],
            ['name' => 'purchases.receive', 'display_name' => 'Receive Purchase Orders', 'group' => 'Purchase Orders'],
            ['name' => 'purchases.cancel', 'display_name' => 'Cancel Purchase Orders', 'group' => 'Purchase Orders'],
            ['name' => 'purchases.delete', 'display_name' => 'Delete Purchase Orders', 'group' => 'Purchase Orders'],

            ['name' => 'purchase_returns.view', 'display_name' => 'View Purchase Returns', 'group' => 'Purchase Returns'],
            ['name' => 'purchase_returns.create', 'display_name' => 'Create Purchase Returns', 'group' => 'Purchase Returns'],
            ['name' => 'purchase_returns.approve', 'display_name' => 'Approve Purchase Returns', 'group' => 'Purchase Returns'],
            ['name' => 'purchase_returns.complete', 'display_name' => 'Complete Purchase Returns', 'group' => 'Purchase Returns'],
            ['name' => 'purchase_returns.cancel', 'display_name' => 'Cancel Purchase Returns', 'group' => 'Purchase Returns'],
            ['name' => 'purchase_returns.delete', 'display_name' => 'Delete Purchase Returns', 'group' => 'Purchase Returns'],
        ...
        $roles = [
            ...
            'manager' => [
                ...
                'purchases.view', 'purchases.create', 'purchases.update', 'purchases.approve', 'purchases.receive', 'purchases.cancel', 'purchases.delete',
                'purchase_returns.view', 'purchase_returns.create', 'purchase_returns.approve', 'purchase_returns.complete', 'purchase_returns.cancel', 'purchase_returns.delete',
